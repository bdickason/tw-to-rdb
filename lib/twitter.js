...
(function() {
  ...
  exports.Twitter = Twitter = (function() {
    ...
    function Twitter(cfg, redis) {
      ...
      this.cfg = cfg;
      this.redis = redis;
      this.oa = oa = new OAuth('https://api.twitter.com/oauth/request_token', 'https://api.twitter.com/oauth/access_token', this.cfg.TW_CONSUMER_KEY, this.cfg.TW_CONSUMER_SECRET, '1.0', 'http://localhost:3000/tw/callback', 'HMAC-SHA1');
    }
