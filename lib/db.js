...
(function() {
  ...
  exports.Db = Db = (function() {
    ...
    Db.prototype.doesAccountExist = function(user_name, app_name, callback) {
      var _this = this;
      if (user_name && app_name) {
        return this.redis.sismember("user:" + user_name, app_name, function(error, reply) {
          return callback(error, reply);
        });
      } else {
        if (!user_name) {
    ...
    Db.prototype.createAccount = function(user_name, app_name, callback) {
      var _this = this;
      if (user_name && app_name) {
        return this.redis.sadd("users", "user:" + user_name, function(error, reply) {
          return _this.redis.sadd("user:" + user_name, app_name, function(error, reply) {
            return callback(error, reply);
          });
        });
      } else {
